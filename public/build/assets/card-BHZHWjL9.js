import{j as t}from"./app-nUTISrBt.js";const g=({children:r,className:s="",variant:e="default",padding:a="md",shadow:o="md",hover:d=!1,onClick:l,...n})=>{const b={default:"bg-[var(--surface-00)] border-[var(--border-light)]",elevated:"bg-[var(--surface-00)] border-[var(--border-light)] shadow-lg",outline:"bg-transparent border-[var(--border-medium)] border-2",ghost:"bg-transparent border-[var(--border-light)]"},m={xs:"p-2",sm:"p-3",md:"p-4",lg:"p-6",xl:"p-8"},i={sm:"shadow-sm",md:"shadow-md",lg:"shadow-lg",xl:"shadow-xl",none:"shadow-none"};return t.jsx("div",{className:`
        rounded-lg border
