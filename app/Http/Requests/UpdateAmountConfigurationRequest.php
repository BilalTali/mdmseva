...
class UpdateAmountConfigurationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        // Add primary validation rules if user has primary students
        ...
        // Add middle validation rules if user has middle students
        ...
        // ✅ Unified salt percentage fields (always required, apply to both primary and middle)
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            // ✅ Validate unified salt percentages sum to 100 (single check for both primary and middle)
            $total = 
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Set primary rates to 0 if user doesn't have primary students
        if (!$user->hasPrimaryStudents()) {
        ...
        // Set middle rates to 0 if user doesn't have middle students
        if (!$user->hasMiddleStudents()) {
        ...
        // ✅ Set default unified salt percentages if not provided
