...
<head>
    <meta charset="utf-8">
    <title>Roll Statement - <?php echo e($academic_year); ?></title>
    <style>
...
<div class="content-wrapper">
    ...
    ?>
        ...
        <div class="report-header">
            ...
            <div class="district-zone-row">
                District: <?php echo e($user->district->name ?? $user->district ?? 'N/A'); ?> 
                <span class="heading-separator">|</span>
                Zone: <?php echo e($user->zone->name ?? $user->zone ?? 'N/A'); ?> 
                <span class="heading-separator">|</span>
                UDISE: <?php echo e($user->udise_code ?? $user->udise ?? 'N/A'); ?>
            ...
            <div class="single-line-info">
                ...
                Academic Year: <?php echo e($academic_year); ?> <span class="heading-separator">•</span> 
                Date: <?php echo e(\Carbon\Carbon::parse($date)->format('F d, Y')); ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php if($showPrimary): ?>
                <?php $__currentLoopData = $primaryClassNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $className): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <?php if($stmt): ?>
                        ...
                        <tr>
                            ...
                            <td class="class-cell">
                                <span class="class-pill"><?php echo e($stmt->class_label); ?></span>
                            </td>
                            <td><?php echo e($stmt->boys); ?></td>
                            <td><?php echo e($stmt->girls); ?></td>
                            <td><strong><?php echo e($stmt->total); ?></strong></td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                
                <?php if($primaryTotal > 0): ?>
            ...
            <?php if($showUpper): ?>
                <?php $__currentLoopData = $upperClassNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $className): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $stmt = $rollStatements->first(function($s) use ($className) {
                            return strtolower($s->class) === strtolower($className);
                        });
            ...
            <tr class="grand-total-row">
                ...
                <td><strong><?php echo e($rollStatements->sum('boys')); ?></strong></td>
                <td><strong><?php echo e($rollStatements->sum('girls')); ?></strong></td>
                <td><strong><?php echo e($rollStatements->sum('total')); ?></strong></td>
            </tr>
        </tbody>
    </table>
