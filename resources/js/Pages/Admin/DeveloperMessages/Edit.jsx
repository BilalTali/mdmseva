...
export default function EditTeamMember({ message }) {
    ...
    const [imagePreview, setImagePreview] = useState(
        message.image_path ? `/storage/${message.image_path}` : null
    );
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.developer-messages.update', message.id));
    };

    const handleDelete = () => {
        if (confirm('Are you sure you want to delete this team member?')) {
            router.delete(route('admin.developer-messages.destroy', message.id));
        }
    };
